...
[Chinese user guide](README.zh-CN.md) · [Kanban board acceptance](docs/kanban-board-acceptance.zh-CN.md) · [Herdr runner acceptance](docs/herdr-runner-acceptance.zh-CN.md) · [Implementation plan](docs/implementation-plan.zh-CN.md) · [Acceptance record](docs/acceptance.zh-CN.md)
